...
read_results("./runs/Final_20260211_1205_132934/", "model_epoch008","summer")
read_results("./runs/Final_20260211_1205_132934/", "model_epoch008","spring")
read_results("./runs/Final_20260211_1205_132934/", "model_epoch008","winter")
read_results("./runs/Final_20260211_1205_132934/", "model_epoch008","fall")
results0a, metrix0a =read_results("./runs/Final_20260211_1205_132934/", "model_epoch008","all")
read_results_2degree("./runs/Final_20260211_1205_132934/", "model_epoch008",2)


#%%
# The five evaluation matrix of stream temperature predictions for the test basins.
df=pd.read_csv("./runs/Final_20260211_1205_132934/test/model_epoch008/all_evaluation_metrix.csv",index_col=0)
df_summer=pd.read_csv("./runs/Final_20260211_1205_132934/test/model_epoch008/all_evaluation_metrix_summer.csv",index_col=0)
df_spring=pd.read_csv("./runs/Final_20260211_1205_132934/test/model_epoch008/all_evaluation_metrix_spring.csv",index_col=0)
df_fall=pd.read_csv("./runs/Final_20260211_1205_132934/test/model_epoch008/all_evaluation_metrix_fall.csv",index_col=0)
df_winter=pd.read_csv("./runs/Final_20260211_1205_132934/test/model_epoch008/all_evaluation_metrix_winter.csv",index_col=0)
df_2c=pd.read_csv("./runs/Final_20260211_1205_132934/test/model_epoch008/all_evaluation_metrix_2degree.csv",index_col=0)
...
def boxplot(x,y,color,data,y1,y2):
    ...
    box1=sns.boxplot(data=data, x=x, y=y, hue=x, linewidth=2,notch=True,medianprops={"color": "black"},width=0.4,  palette=palette, showfliers = False, dodge=False, legend=False)
...
for i in list(df.index):
    ...
    wshd = str(wshd)
    if wshd not in results:
        wshd = next(iter(results))
...
for wshd in wshds:
    ...
    qobs = qobs.join(qsim[['mean_temp_c_sim']], how='inner')
    total=qobs['mean_temp_c_sim'].notna().sum()
    if total == 0:
        overl.append(float('nan'))
        underl.append(float('nan'))
        continue
...
ax.set_xticks([1, 2])
ax.set_xticklabels(['Obs<=0 & Sim>0', 'Sim<=0 & Obs>0'], rotation=20, ha='right')
ax.set_ylabel('Percent of winter days (%)')
fig.tight_layout()
plt.show()
